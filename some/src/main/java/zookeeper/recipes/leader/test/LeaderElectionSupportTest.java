package zookeeper.recipes.leader.test;
...
import zookeeper.recipes.ClientBase;
import zookeeper.recipes.leader.LeaderElectionSupport;
...
public class LeaderElectionSupportTest extends ClientBase {
  ...
  public void setUp() throws Exception {
    ...
    zooKeeper = new ZooKeeper("172.20.183.137:2181", sessionTimeout,null);
